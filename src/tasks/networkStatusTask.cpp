/**
 * @file networkStatusTask.cpp
 * @brief Network Status Task Implementation
 * 
 * @details This file implements the networkStatusTask function, which is responsible for managing the network connection status.
 * It checks for system readiness, maintains the WiFi and LTE connections, and updates the network event group accordingly.
 * 
 * 
 */
...
#define NETWORK_CONNECTED_BIT BIT0 ///< Network connected event bit
#define SYSTEM_READY_BIT BIT1 ///< System ready event bit
 ...
 * @param pvParameters 
 * 
 * @details This function runs in a FreeRTOS task and manages the network connection status.
 * 
 */
