 ...
 * @file network.cpp
 * 
 * @details Network management for WiFi and LTE connections
 * 
 */
...
/**
 * @brief Initializes the network hardware
 * 
 */
...
/**
 * @brief Connects to LTE network using the specified APN
 * 
 * @param apn 
 * @return true 
 * @return false 
...
/** 
 * @brief Disconnects from the LTE network
 * 
 */
...
/**
 * @brief Checks if the device is connected to LTE network
 * 
 * @return true 
 * @return false 
 */
...
/**
 * @brief Checks if the device is connected to either WiFi or LTE network
 * 
 * @return true 
 * @return false 
 */
...
/**
 * @brief Maintains the network connection by checking WiFi and LTE status
 * 
 * @param ssid 
 * @param password 
 * @param apn 
