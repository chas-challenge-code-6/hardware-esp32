...
// DEVICE_ID for API
#define DEVICE_ID "SENTINEL-001" </// Unique identifier for the device, used in API requests

// Mutex declarations
extern SemaphoreHandle_t serialMutex; ///< Serial mutex for thread-safe printing
extern SemaphoreHandle_t modemMutex; ///< Modem mutex for thread-safe modem operations
extern SemaphoreHandle_t networkEventMutex; ///< Mutex for network event handling
